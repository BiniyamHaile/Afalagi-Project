...
export function Joblists(){
    return(
       ...
       <div className = "alice-items container ">
            ...
            <div  className="mt-md-5">  <h4><i className="bi bi-house-heart-fill"></i> Education</h4>  </div>
            <div  className="mt-md-5">  <h4> <i className="bi bi-stack"></i> Graphics Design</h4>  </div>
            <div  className="mt-md-5">  <h4><i className="bi bi-bag-fill"></i> Market Research</h4>  </div>
            <div  className="mt-md-5">  <h4><i className="bi bi-book"></i> Law</h4>  </div>
       </div>
        </div>
    )
}