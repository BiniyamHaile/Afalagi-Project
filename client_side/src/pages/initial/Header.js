...
export default function Header(){
    ...
    return(
        ...
        <div className = {`${isFixed ? "headerContainer bg-primary fixed"  : "headerContainer"}`}>
           ...
           <div>
            <button className={isFixed ? "btn btn-link text-light d-none d-md-inline": "btn btn-link d-none d-md-inline "} onClick={()=>handleClickScroll('about')}>ABOUT US</button>
            <button className={isFixed ? "btn btn-link text-light d-none d-md-inline": "btn btn-link d-none d-md-inline"} onClick={()=>handleClickScroll('footer')}>CONTACT US</button>
